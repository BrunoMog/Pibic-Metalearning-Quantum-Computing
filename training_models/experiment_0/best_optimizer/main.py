...
# carregar dados
df = pd.read_csv("./../../../meta_dados/input_data/experiment_0/best_embedding_sample_0.csv")
...
mapping_y_custom = mapping_y_custom[0]
            ...
            try:
                ...
                for param_grid in param_grids:
                    ...
                    custom_search = CustomRandomizedSearchCV(
                        ...
                        n_jobs=-1,  # Paralelização com todos os núcleos disponíveis
